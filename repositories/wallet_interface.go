...
type WalletRepository interface {
	...
	Deposit(ctx context.Context, tx *sql.Tx, data web.DepositRequest) (domain.Wallet, error)
	Withdrawal(ctx context.Context, tx *sql.Tx, data web.WithdrawalRequest) (domain.Wallet, error)
